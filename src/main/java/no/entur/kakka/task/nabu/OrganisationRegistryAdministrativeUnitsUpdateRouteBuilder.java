...
package no.entur.kakka.task.nabu;
...
import no.entur.kakka.task.netex.TopographicPlaceAdapter;
...
import no.entur.kakka.task.sosi.SosiTopographicPlaceAdapterReader;
