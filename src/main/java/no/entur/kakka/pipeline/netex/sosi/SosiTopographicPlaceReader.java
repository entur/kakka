...
package no.entur.kakka.pipeline.netex.sosi;


import no.entur.kakka.pipeline.netex.TopographicPlaceMapper;
import no.entur.kakka.pipeline.netex.TopographicPlaceReader;
import no.entur.kakka.pipeline.sosi.SosiElementWrapperFactory;
import no.entur.kakka.pipeline.sosi.SosiTopographicPlaceAdapterReader;
